...
for _, child in ipairs(game.ReplicatedStorage:GetDescendants()) do
	if child.Name:lower():find(("KuyoShibari"):lower()) and child.ClassName == "Animation" then
...
for _, child in ipairs(game.ReplicatedStorage:GetDescendants()) do
	if child.Name:lower():find(("FeedingFrenzy"):lower()) and child.ClassName == "Animation" then
		table.insert(extendtheblock, child.AnimationId)
	end
end
...
local hounce = false
game.UserInputService.InputBegan:connect(function(input)
	if input.KeyCode == Enum.KeyCode.C or input.KeyCode == Enum.KeyCode.Z or input.KeyCode == Enum.KeyCode.One or input.KeyCode == Enum.KeyCode.Two or input.KeyCode == Enum.KeyCode.Six then
		hounce = true
	end
end)
]]--
...
local hounce = false
game.UserInputService.InputBegan:connect(function(input)
	if input.KeyCode == Enum.KeyCode.Six or input.KeyCode == Enum.KeyCode.C or input.KeyCode == Enum.KeyCode.U or input.KeyCode == Enum.KeyCode.Tab then
		hounce = true
	end
end)
					...
					if game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
						...
						if game.Players.LocalPlayer.Character:GetAttribute("CurrentState") ~= "Unconscious" and game.Players.LocalPlayer.Character:GetAttribute("CurrentState") ~= "TrueStunned" and game.Players.LocalPlayer.Character:GetAttribute("CurrentState") ~= "Dying" then
							...
							if hounce then
								...
								Target["Left Leg"].Position.Y, Target.HumanoidRootPart.Position.Z + Target.HumanoidRootPart.Velocity.Z * 0.14)) }):Play()
								task.wait(0.15)
