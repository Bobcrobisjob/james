...
--[[
	...
	runLoop = game:GetService("RunService").RenderStepped:Connect(function(deltaTime)
		...
		if Target and not WhohasTheBall() and not ClosestIB() then
			...
			char.Humanoid.WalkSpeed = Target.Character.Humanoid.WalkSpeed * 0.925
			...
			game.Players.LocalPlayer.Character.HumanoidRootPart.CustomPhysicalProperties = PhysicalProperties.new(0.8, 0.300000012, 0.5, 1, 1) 
